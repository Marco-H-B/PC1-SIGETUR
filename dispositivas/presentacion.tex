...
\begin{frame}{Modelo del Negocio: De los Procesos a los Casos de Uso}
    \begin{block}{\textbf{Fundamento Metodológico (García Molina et al., Universidad de Murcia)}}
        \small
...
\begin{frame}{Requisitos No Funcionales (FURPS+) y Reglas de Negocio}
    \begin{columns}[t]
        \begin{column}{0.48\textwidth}
            \begin{block}{\textbf{Requisitos No Funcionales (RNF)}}
                \scriptsize
                \begin{itemize}
